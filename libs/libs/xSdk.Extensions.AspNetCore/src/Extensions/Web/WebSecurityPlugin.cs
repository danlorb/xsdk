...
{
    public class WebSecurityPlugin : PluginBase, IServicesPluginConfig, IApplicationPluginConfig
    {
        ...
        {
            var webSetup = SlimHost.Instance.VariableSystem.GetSetup<WebSetup>();
            var securitySetup = SlimHost.Instance.VariableSystem.GetSetup<WebSecuritySetup>();
            ...
            IEnumerable<string> origins = new List<string> { webSetup.BuildBaseUrl() };
