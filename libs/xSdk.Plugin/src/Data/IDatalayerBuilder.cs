...
namespace xSdk.Data
{
    ...
    {
        IDatalayerBuilder ConfigureDatabase<TDatabase, TDatabaseSetup, TConnectionStringBuilder>(
            string name,
            Action<TDatabaseSetup> factory
        )
        ...
        IDatalayerBuilder ConfigureRepository<TInterface, TImplementation>(
