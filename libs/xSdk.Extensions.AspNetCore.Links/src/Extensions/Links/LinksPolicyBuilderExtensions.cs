...
using xSdk.Extensions.Links.Requirements;
...
namespace xSdk.Extensions.Links
{
    public static class LinksPolicyBuilderExtensions
    {
        ...
        public static LinksPolicyBuilder<TResource> RequireSelfLink<TResource>(this LinksPolicyBuilder<TResource> builder, string id)
        {
            return builder.Requires(new SelfLinkRequirement<TResource>() { Id = id });
        }

        public static LinksPolicyBuilder<TResource> RequireRoutedLink<TResource>(this LinksPolicyBuilder<TResource> builder, string id, string routeName)
        {
        ...
        public static LinksPolicyBuilder<TResource> RequiresPagingLinks<TResource>(
            this LinksPolicyBuilder<TResource> builder,
            string currentId,
            string nextId,
            string previousId
        ...
        private static LinksPolicyBuilder<TResource> RequiresPagingLinks<TResource>(
            this LinksPolicyBuilder<TResource> builder,
            string currentId,
            string nextId,
            string previousId,
