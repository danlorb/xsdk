...
{
    public enum LinkRequirementSkipReason
    {
        Assertion,
        Authorization,
        Error,
    ...
    public class LinksHandlerContext
    {
        ...
        public IQueryCollection CurrentQueryValues => ActionContext?.HttpContext?.Request?.Query;
        ...
        public virtual void Skipped(ILinksRequirement requirement, LinkRequirementSkipReason reason = LinkRequirementSkipReason.Custom, string message = null)
        {
            ...
            Logger.LogInformation(
                "Link {Requirement} skipped for user {User}. Reason: {LinkSkipReason}. {Message}.",
                requirement,
                username,
                reason,
